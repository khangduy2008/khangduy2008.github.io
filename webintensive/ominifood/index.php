...
<body>
    ...
    <section class="part_2 container">
        <div class="intro">
        ...
        <div class="detail">
            <div class="row">
                <div class="item col-lg-3 col-md-6">
                    ...
                    <div class=>Up to 365 days/year</div>
                    <p>Never cook again! We really mean that. Our subscription plans include up to 365 days/year coverage. You can also choose to order more flexibly if that's your style</p>
                </div>
                <div class="item col-lg-3 col-md-6">
                    <i class="fal fa-clock"></i>
                    <div>Ready in 20 minutes</div>
    ...
    <section class="part_4 container">
        <div class="intro">
            <p class="title">How it works - simple 1,2,3</p> 
        </div>
        <div class="detail">
            <div class="p4_left">
    ...
    <section class="part_5 container">
<div class="intro"><p class="title">We're currently in these cities</p></div>
<div class="detail">
    <div class="item col-lg-3 col-md-6">
        <img src="./img/lisbon-3.jpg" alt="">
        <p id="p1">Libon</p>
        <p><i class="fas fa-user"></i>1600+ happy eaters</p>
        <p><i class="fad fa-stars"></i>60+ top chefs</p>
        <p id="p2"><i class="fab fa-twitter"></i>@omnifood_lx</p>
    </div>
    <div class="item col-lg-3 col-md-6">
        <img src="./img/san-francisco.jpg" alt="">
        <p id="p1">San-francisco</p>
        <p><i class="fas fa-user"></i>3700+ happy eaters</p>
        <p><i class="fad fa-stars"></i>160+ top chefs</p>
        <p id="p2"><i class="fab fa-twitter"></i>@omnifood_sf</p>
    </div>
    <div class="item col-lg-3 col-md-6">
        <img src="./img/berlin.jpg" alt="">
        <p id="p1">Berlin</p>
        <p><i class="fas fa-user"></i>2300+ happy eaters</p>
        <p><i class="fad fa-stars"></i>110+ top chefs</p>
        <p id="p2"><i class="fab fa-twitter"></i>@omnifood_berlin</p>
    </div>
    <div class="item col-lg-3 col-md-6">
        <img src="./img/london.jpg" alt="">
        <p id="p1">London</p>
        <p><i class="fas fa-user"></i>1200+ happy eaters</p>
        <p><i class="fad fa-stars"></i>50+ top chefs</p>
        <p id="p2"><i class="fab fa-twitter"></i>@omnifood_lodon</p>
    </div>
</div>
    ...
    <section class="part_6 container">
        <div class="intro">
            <p class="title">Start eating healthy today</p>
        </div>
        <div class="detail">
                ...
                <div class="cart">
                    ...
                    <div class="div">
                        ...
                        <span id="span2" >/month</span>
                
                    </div>
                    <p>That’s only 13.30$ per meal</p>
                    <hr>
                    <p class="p2"><i class="far fa-check"></i>  1 meal every day</p>
                    <p class="p2"><i class="far fa-check"></i>  Order 24/7</p>
                    <p class="p2"><i class="far fa-check"></i>  Access to newest creations</p>
                    <p class="p2"><i class="far fa-check"></i>  Free delivery</p>
                    <hr>
                    <p id="p3">sign up now</p>
                </div>
                <div class="cart">
                    <p id="p1">Pro</p>
                    <div class="div">
                        <span id="span1" >$149</span>
                        <span id="span2" >/month</span>
                
                    </div>
                    <p>That’s only 14.90$ per meal</p>
                    <hr>
                    <p class="p2"><i class="far fa-check"></i>  1 meal 10 days/month</p>
                    <p class="p2"><i class="far fa-check"></i>  Order 24/7</p>
                    <p class="p2"><i class="far fa-check"></i>  Access to newest creations</p>
                    <p class="p2"><i class="far fa-check"></i>  Free delivery</p>
                    <hr>
                ...
                <div class="cart">
                    <p id="p1">Starter</p>
                    <div class="div">
                        <span id="span1" >$19</span>
                        <span id="span2" >/meal</span>
                
                    </div>
                    <p>That’s only 19$ per meal</p>
                    <hr>
                    <p class="p2"><i class="far fa-check"></i>  1 meal</p>
                    <p class="p2"><i class="far fa-check"></i>  Order from 8am to 12pm</p>
                    <p class="p2"><i class="far fa-check"></i>  </p>
                    <p class="p2"><i class="far fa-check"></i>  Free delivery</p>
                    <hr>
                    <p id="p3">sign up now</p>
                </div>
    ...
    <section class="part_7 container">
        <div class="intro">
